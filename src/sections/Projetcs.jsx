  ...
  return (
    <section id='projects' className='relative min-h-screen py-24 px-4'>
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute bottom-32 left-20 w-96 h-96 bg-white/[0.03] rounded-full blur-[100px]" />
      </div>
      ...
      <div className='relative z-10 max-w-7xl mx-auto'>
        ...
        <div className='text-center mb-16'>
          ...
          <p className='text-slate-400 text-lg max-w-2xl mx-auto'>
            Sélection de projets réalisés lors de mes deux premières années à Epitech
          </p>
        </div>
        ...
        <div className='grid lg:grid-cols-2 xl:grid-cols-3 gap-8'>
          {projects.map((project, index) => (
            <div key={project.id} className="group">
              <div className="bg-black/30 backdrop-blur-sm rounded-2xl border border-white/10 hover:border-white/20 transition-all duration-300 relative overflow-hidden h-full cursor-pointer" onClick={() => openProjectModal(project)}>
                <div className="relative z-10 p-6 h-full flex flex-col">
                  ...
                  <div className="flex-1 flex flex-col">
                    ...
                    {/* Technologies */}
                    <div className="mb-6">
                      <h4 className="text-xs font-semibold text-slate-500 mb-2 uppercase tracking-wider">Technologies</h4>
                      <div className="flex flex-wrap gap-2">
                        {project.technologies.map((tech, techIndex) => (
                          <span 
                            key={techIndex}
                            className="px-2 py-1 bg-white/5 border border-white/10 rounded-full text-xs text-slate-300 hover:border-white/20 transition-colors cursor-default"
                          >
                            {tech}
                          </span>
                        ))}
        ...
        {selectedProject && (
          <div className="fixed inset-0 bg-black/80 backdrop-blur-sm z-50 flex items-center justify-center p-4" onClick={closeProjectModal}>
            <div className="bg-gray-950 rounded-2xl border border-white/10 max-w-4xl w-full max-h-[90vh] overflow-y-auto shadow-2xl shadow-black/20" onClick={(e) => e.stopPropagation()}>
              {/* Modal Header */}
              <div className="sticky top-0 bg-gray-950/95 backdrop-blur-sm border-b border-white/10 p-6 rounded-t-2xl">
              ...
              <div className="p-6">
                ...
                <div className="grid md:grid-cols-2 gap-8 mb-8">
                  ...
                  <div>
                    ...
                    <div className="mb-6">
                      ...
                      <p className="text-slate-400 leading-relaxed whitespace-pre-line">{selectedProject.fullDescription}</p>
                    </div>
                    ...
                    <div className="mb-6">
                      ...
                      <div className="flex flex-wrap gap-3">
                        {selectedProject.technologies.map((tech, index) => (
                          <span 
                            key={index}
                            className="px-4 py-2 bg-white/5 border border-white/10 rounded-full text-slate-300"
                          >
                            {tech}
                          </span>
                        ))}
                ...
                <div className="flex gap-4 pt-6 border-t border-white/10">
                  <a 
                    ...
                    className="flex-1 flex items-center justify-center gap-3 px-6 py-4 bg-white/5 border border-white/10 hover:border-white/20 rounded-xl text-slate-300 hover:text-white transition-all duration-300"
                  >
                  ...
                  {/* <a 
                    ...
                    target='_blank'
                    rel="noopener noreferrer"
                    className="flex-1 flex items-center justify-center gap-3 px-6 py-4 bg-white/10 border border-white/20 hover:bg-white/20 rounded-xl text-white transition-all duration-300"
                  >
