  ...
  return (
    <section id='projects' className='relative min-h-screen py-24 px-4'>
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-32 right-20 w-80 h-80 bg-violet-500/10 rounded-full blur-[100px]" />
        <div className="absolute bottom-32 left-20 w-96 h-96 bg-cyan-500/10 rounded-full blur-[100px]" />
      </div>
      ...
      <div className='relative z-10 max-w-7xl mx-auto'>
        ...
        <div className='grid lg:grid-cols-2 xl:grid-cols-3 gap-8'>
          {projects.map((project, index) => (
            <div key={project.id} className="group">
              <div className="bg-black/30 backdrop-blur-sm rounded-2xl border border-white/10 hover:border-cyan-500/20 transition-all duration-300 relative overflow-hidden h-full cursor-pointer" onClick={() => openProjectModal(project)}>
                    ...
                    <div className="mb-6">
                      ...
                      <div className="flex flex-wrap gap-2">
                        {project.technologies.map((tech, techIndex) => (
                          <span 
                            key={techIndex}
                            className="px-2 py-1 bg-cyan-500/10 border border-cyan-500/20 rounded-full text-xs text-cyan-300 hover:border-cyan-400/30 transition-colors cursor-default"
                          >
                            {tech}
                          </span>
                        ))}
        ...
        {selectedProject && (
          <div className="fixed inset-0 bg-black/80 backdrop-blur-sm z-50 flex items-center justify-center p-4" onClick={closeProjectModal}>
            <div className="bg-gray-950 rounded-2xl border border-white/10 max-w-4xl w-full max-h-[90vh] overflow-y-auto shadow-2xl shadow-cyan-500/5" onClick={(e) => e.stopPropagation()}>
              {/* Modal Header */}
              ...
              <div className="p-6">
                    ...
                    <div className="mb-6">
                      ...
                      <div className="flex flex-wrap gap-3">
                        {selectedProject.technologies.map((tech, index) => (
                          <span 
                            key={index}
                            className="px-4 py-2 bg-cyan-500/10 border border-cyan-500/20 rounded-full text-cyan-300"
                          >
                            {tech}
                          </span>
                        ))}
                ...
                <div className="flex gap-4 pt-6 border-t border-white/10">
                  <a 
                    ...
                    className="flex-1 flex items-center justify-center gap-3 px-6 py-4 bg-white/5 border border-white/10 hover:border-cyan-500/30 rounded-xl text-slate-300 hover:text-cyan-300 transition-all duration-300"
                  >
